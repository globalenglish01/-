...
```
# 🎬 01_Udemy - Apache Airflow The Hands-On Guide p01 1. Important Prerequisites
...
```
# 🎬 02_Udemy - Apache Airflow The Hands-On Guide p02 2. The Roadmap
...
```
# 🎬 03_Udemy - Apache Airflow The Hands-On Guide p03 3. Who I am
...
```
# 🎬 04_Udemy - Apache Airflow The Hands-On Guide p04 4. Development Environment
...
```
# 🎬 05_Udemy - Apache Airflow The Hands-On Guide p05 1. Why data orchestration
...
```
# 🎬 06_Udemy - Apache Airflow The Hands-On Guide p06 2. Why Airflow
...
```
# 🎬 07_Udemy - Apache Airflow The Hands-On Guide p07 3. The Core Components
...
```
# 🎬 08_Udemy - Apache Airflow The Hands-On Guide p08 4. The Core Concepts
...
```
# 🎬 09_Udemy - Apache Airflow The Hands-On Guide p09 5. How does Airflow work
...
```
# 🎬 10_Udemy - Apache Airflow The Hands-On Guide p10 6. Airflow limitations
...
```
# 🎬 11_Udemy - Apache Airflow The Hands-On Guide p11 7. Practice Installing Airflow
...
```
# 🎬 12_Udemy - Apache Airflow The Hands-On Guide p12 9. Practice Quick tour of Airflow UI
...
```
# 🎬 13_Udemy - Apache Airflow The Hands-On Guide p13 10. Practice Quick tour of Airflow CLI
...
```
# 🎬 14_Udemy - Apache Airflow The Hands-On Guide p14 11. Practice The Rest API
...
```
# 🎬 15_Udemy - Apache Airflow The Hands-On Guide p15 1. Introduction
...
```
# 🎬 16_Udemy - Apache Airflow The Hands-On Guide p16 2. The Project! What you will build
...
```
# 🎬 17_Udemy - Apache Airflow The Hands-On Guide p17 3. Project materials
...
```
# 🎬 18_Udemy - Apache Airflow The Hands-On Guide p18 4. Running the new environment
...
```
# 🎬 19_Udemy - Apache Airflow The Hands-On Guide p19 7. Create the DAG with the dag decorator
...
```
# 🎬 20_Udemy - Apache Airflow The Hands-On Guide p20 8. The new way of authoring DAGs with Taskflow
...
```
# 🎬 21_Udemy - Apache Airflow The Hands-On Guide p21 10. Checking API availability with the Sensor decorator
...
```
# 🎬 22_Udemy - Apache Airflow The Hands-On Guide p22 11. Fetching stock prices with the PythonOperator
...
```
# 🎬 23_Udemy - Apache Airflow The Hands-On Guide p23 12. Storing stock prices in MinIO (AWS S3 like)
...
```
# 🎬 24_Udemy - Apache Airflow The Hands-On Guide p24 13. Formatting stock prices with Spark and the DockerOperator
...
```
# 🎬 25_Udemy - Apache Airflow The Hands-On Guide p25 14. Fetching formatted prices from MinIO (AWS S3 like)
...
```
# 🎬 26_Udemy - Apache Airflow The Hands-On Guide p26 15. The best way to load files into data warehouses with Postgres and Astro SDK
...
```
# 🎬 27_Udemy - Apache Airflow The Hands-On Guide p27 16. Creating the dashboard to track Apple stock with Metabase
...
```
# 🎬 28_Udemy - Apache Airflow The Hands-On Guide p28 17. The pipeline in action!
...
```
# 🎬 29_Udemy - Apache Airflow The Hands-On Guide p29 18. Getting alerts on Slack with the new Notifiers
...
```
# 🎬 30_Udemy - Apache Airflow The Hands-On Guide p30 1. Set up the new Airflow environment
...
```
# 🎬 31_Udemy - Apache Airflow The Hands-On Guide p31 2. The best way to create your DAGs
...
```
# 🎬 32_Udemy - Apache Airflow The Hands-On Guide p32 3. The parameters your DAGs need
...
```
# 🎬 33_Udemy - Apache Airflow The Hands-On Guide p33 4. DAG scheduling the basics
...
```
# 🎬 34_Udemy - Apache Airflow The Hands-On Guide p34 5. Backfill and Catchup
...
```
# 🎬 35_Udemy - Apache Airflow The Hands-On Guide p35 6. The most important rule to follow when creating tasks
...
```
# 🎬 36_Udemy - Apache Airflow The Hands-On Guide p36 7. Play by scheduling your DAGs
...
```
# 🎬 37_Udemy - Apache Airflow The Hands-On Guide p37 8. Dealing with timezones in Airflow
...
```
# 🎬 38_Udemy - Apache Airflow The Hands-On Guide p38 9. Scheduling DAGs based on data with Datasets
...
```
# 🎬 39_Udemy - Apache Airflow The Hands-On Guide p39 10. Conditional Dataset scheduling
...
```
# 🎬 40_Udemy - Apache Airflow The Hands-On Guide p40 11. Datasets in action!
...
```
# 🎬 41_Udemy - Apache Airflow The Hands-On Guide p41 12. Sharing data between task with XComs
...
```
# 🎬 42_Udemy - Apache Airflow The Hands-On Guide p42 13. Organize your DAGs folder and clean your DAGs
...
```
# 🎬 43_Udemy - Apache Airflow The Hands-On Guide p43 14. Manage task and DAG failures
...
```
# 🎬 44_Udemy - Apache Airflow The Hands-On Guide p44 15. Test your tasks and DAGs
...
```
# 🎬 45_Udemy - Apache Airflow The Hands-On Guide p45 1. The right way of grouping tasks
...
```
# 🎬 46_Udemy - Apache Airflow The Hands-On Guide p46 2. Choosing tasks with branching and conditions
...
```
# 🎬 47_Udemy - Apache Airflow The Hands-On Guide p47 3. Changing execution behaviours with Trigger Rules
...
```
# 🎬 48_Udemy - Apache Airflow The Hands-On Guide p48 4. Templating your tasks
...
```
# 🎬 49_Udemy - Apache Airflow The Hands-On Guide p49 5. The smart way of storing data with Custom XCOM backends
...
```
# 🎬 50_Udemy - Apache Airflow The Hands-On Guide p50 6. Using variables to avoid hardcoding values
...
```
# 🎬 51_Udemy - Apache Airflow The Hands-On Guide p51 1. Executing tasks sequentially with the SequentialExecutor and SQLite
...
```
# 🎬 52_Udemy - Apache Airflow The Hands-On Guide p52 2. Executing tasks in parallel with the LocalExecutor and Postgres
...
```
# 🎬 53_Udemy - Apache Airflow The Hands-On Guide p53 3. Concurrency settings to control how tasks and dags run in parallel
...
```
# 🎬 54_Udemy - Apache Airflow The Hands-On Guide p54 4. Start scaling Airflow with the CeleryExecutor
...
```
# 🎬 55_Udemy - Apache Airflow The Hands-On Guide p55 5. Track your tasks using Flower with the CeleryExecutor
...
```
# 🎬 56_Udemy - Apache Airflow The Hands-On Guide p56 6. Add new workers and configure queues to distribute your tasks
...
```
# 🎬 57_Udemy - Apache Airflow The Hands-On Guide p57 7. Quick introduction to Kubernetes
...
```
# 🎬 58_Udemy - Apache Airflow The Hands-On Guide p58 8. Introduction to the KubernetesExecutor
...
```
# 🎬 59_Udemy - Apache Airflow The Hands-On Guide p59 9. Installing Airflow on a Kubernetes cluster
...
```
# 🎬 60_Udemy - Apache Airflow The Hands-On Guide p60 10. How to configure Airflow on Kubernetes
...
```
# 🎬 61_Udemy - Apache Airflow The Hands-On Guide p61 11. Deploying DAGs with Airflow on Kubernetes using GitSync
...
```
# 🎬 62_Udemy - Apache Airflow The Hands-On Guide p62 1. Introduction
...
```
# 🎬 63_Udemy - Apache Airflow The Hands-On Guide p63 2. Quick overview of AWS EKS
...
```
# 🎬 64_Udemy - Apache Airflow The Hands-On Guide p64 3. Practice Set up an EC2 instance for Rancher
...
```
# 🎬 65_Udemy - Apache Airflow The Hands-On Guide p65 4. Practice Create an IAM User with permissions
...
```
# 🎬 66_Udemy - Apache Airflow The Hands-On Guide p66 5. Practice Create an ECR repository
...
```
# 🎬 67_Udemy - Apache Airflow The Hands-On Guide p67 6. Practice Create an EKS cluster with Rancher
...
```
# 🎬 68_Udemy - Apache Airflow The Hands-On Guide p68 7. How to access your applications from the outside
...
```
# 🎬 69_Udemy - Apache Airflow The Hands-On Guide p69 8. Practice Deploy Nginx Ingress with Catalogs (Helm)
...
```
# 🎬 70_Udemy - Apache Airflow The Hands-On Guide p70 9. Practice Deploy and run Airflow with the Kubernetes Executor on EKS
...
```
# 🎬 71_Udemy - Apache Airflow The Hands-On Guide p71 10. Practice Cleaning your AWS services
...
```
# 🎬 72_Udemy - Apache Airflow The Hands-On Guide p72 1. Introduction
...
```
# 🎬 73_Udemy - Apache Airflow The Hands-On Guide p73 2. How the logging system works in Airflow
...
```
# 🎬 74_Udemy - Apache Airflow The Hands-On Guide p74 3. Practice Setting up custom logging
...
```
# 🎬 75_Udemy - Apache Airflow The Hands-On Guide p75 4. Practice Storing your logs in AWS S3
...
```
# 🎬 76_Udemy - Apache Airflow The Hands-On Guide p76 5. Elasticsearch Reminder
...
```
# 🎬 77_Udemy - Apache Airflow The Hands-On Guide p77 6. Practice Configuring Airflow with Elasticsearch
...
```
# 🎬 80_Udemy - Apache Airflow The Hands-On Guide p80 9. Practice Monitoring Airflow with TIG stack
...
```
# 🎬 83_Udemy - Apache Airflow The Hands-On Guide p83 1. Introduction
...
```
# 🎬 88_Udemy - Apache Airflow The Hands-On Guide p88 6. Practice RBAC UI
...
```
# 🎬 90_Udemy - Apache Airflow The Hands-On Guide p90 1. Backfill your DAGs in Airflow like a PRO
...
```
# 🎬 91_Udemy - Apache Airflow The Hands-On Guide p91 7. VIDEO The DockerOperator The basics and more
