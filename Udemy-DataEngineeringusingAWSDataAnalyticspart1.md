...
```
# 🎬 001_Udemy - Data Engineering using AWS Data Analytics part1 p01 1. Introduction to Data Engineering using AWS Analytics Services
...
```
# 🎬 003_Udemy - Data Engineering using AWS Data Analytics part1 p03 3. Taking the Udemy Course for new Udemy Users
...
```
# 🎬 004_Udemy - Data Engineering using AWS Data Analytics part1 p04 4. Additional Costs for AWS Infrastructure for Hands-on Practice
...
```
# 🎬 005_Udemy - Data Engineering using AWS Data Analytics part1 p05 5. Signup for AWS Account
...
```
# 🎬 006_Udemy - Data Engineering using AWS Data Analytics part1 p06 6. Logging in into AWS Account
...
```
# 🎬 007_Udemy - Data Engineering using AWS Data Analytics part1 p07 7. Overview of AWS Billing Dashboard - Cost Explorer and Budgets
...
```
# 🎬 008_Udemy - Data Engineering using AWS Data Analytics part1 p08 1. Setup Local Environment on Windows for AWS
...
```
# 🎬 009_Udemy - Data Engineering using AWS Data Analytics part1 p09 2. Overview of Powershell on Windows 10 or Windows 11
...
```
# 🎬 010_Udemy - Data Engineering using AWS Data Analytics part1 p10 3. Setup Ubuntu VM on Windows 10 or 11 using wsl
...
```
# 🎬 011_Udemy - Data Engineering using AWS Data Analytics part1 p11 4. Setup Ubuntu VM on Windows 10 or 11 using wsl - Contd
...
```
# 🎬 012_Udemy - Data Engineering using AWS Data Analytics part1 p12 5. Setup Python venv and pip on Ubuntu
...
```
# 🎬 013_Udemy - Data Engineering using AWS Data Analytics part1 p13 6. Setup AWS CLI on Windows and Ubuntu using Pip
...
```
# 🎬 014_Udemy - Data Engineering using AWS Data Analytics part1 p14 7. Create AWS IAM User and Download Credentials
...
```
# 🎬 015_Udemy - Data Engineering using AWS Data Analytics part1 p15 8. Configure AWS CLI on Windows
...
```
# 🎬 016_Udemy - Data Engineering using AWS Data Analytics part1 p16 9. Create Python Virtual Environment for AWS Projects
...
```
# 🎬 017_Udemy - Data Engineering using AWS Data Analytics part1 p17 10. Setup Boto3 as part of Python Virtual Environment
...
```
# 🎬 018_Udemy - Data Engineering using AWS Data Analytics part1 p18 11. Setup Jupyter Lab and Validate boto3
...
```
# 🎬 019_Udemy - Data Engineering using AWS Data Analytics part1 p19 1. Setup Local Environment for AWS on Mac
...
```
# 🎬 020_Udemy - Data Engineering using AWS Data Analytics part1 p20 2. Setup AWS CLI on Mac
...
```
# 🎬 021_Udemy - Data Engineering using AWS Data Analytics part1 p21 3. Setup AWS IAM User to configure AWS CLI
...
```
# 🎬 022_Udemy - Data Engineering using AWS Data Analytics part1 p22 4. Configure AWS CLI using IAM User Credentials
...
```
# 🎬 023_Udemy - Data Engineering using AWS Data Analytics part1 p23 5. Setup Python Virtual Environment on Mac using Python 3
...
```
# 🎬 024_Udemy - Data Engineering using AWS Data Analytics part1 p24 6. Setup Boto3 as part of Python Virtual Environment
...
```
# 🎬 025_Udemy - Data Engineering using AWS Data Analytics part1 p25 7. Setup Jupyter Lab and Validate boto3
...
```
# 🎬 026_Udemy - Data Engineering using AWS Data Analytics part1 p26 1. Introduction to Cloud9
...
```
# 🎬 027_Udemy - Data Engineering using AWS Data Analytics part1 p27 2. Setup Cloud9
...
```
# 🎬 028_Udemy - Data Engineering using AWS Data Analytics part1 p28 3. Overview of Cloud9 IDE
...
```
# 🎬 029_Udemy - Data Engineering using AWS Data Analytics part1 p29 4. Docker and AWS CLI on Cloud9
...
```
# 🎬 030_Udemy - Data Engineering using AWS Data Analytics part1 p30 5. Cloud9 and EC2
...
```
# 🎬 031_Udemy - Data Engineering using AWS Data Analytics part1 p31 6. Accessing Web Applications
...
```
# 🎬 032_Udemy - Data Engineering using AWS Data Analytics part1 p32 7. Allocate and Assign Static IP
...
```
# 🎬 033_Udemy - Data Engineering using AWS Data Analytics part1 p33 8. Changing Permissions using IAM Policies
...
```
# 🎬 034_Udemy - Data Engineering using AWS Data Analytics part1 p34 9. Increasing Size of EBS Volume
...
```
# 🎬 035_Udemy - Data Engineering using AWS Data Analytics part1 p35 10. Opening ports for Cloud9 Instance
...
```
# 🎬 036_Udemy - Data Engineering using AWS Data Analytics part1 p36 11. Setup Jupyter lab on Cloud9 Instance
...
```
# 🎬 037_Udemy - Data Engineering using AWS Data Analytics part1 p37 12. Open SSH Port for Cloud9 EC2 Instance
...
```
# 🎬 038_Udemy - Data Engineering using AWS Data Analytics part1 p38 13. Connect to Cloud9 EC2 Instance using SSH
...
```
# 🎬 039_Udemy - Data Engineering using AWS Data Analytics part1 p39 1. Introduction - AWS Getting Started
...
```
# 🎬 040_Udemy - Data Engineering using AWS Data Analytics part1 p40 3. Create AWS s3 Bucket using AWS Web Console
...
```
# 🎬 041_Udemy - Data Engineering using AWS Data Analytics part1 p41 5. Create AWS IAM Group and User using AWS Web Console
...
```
# 🎬 042_Udemy - Data Engineering using AWS Data Analytics part1 p42 7. Overview of AWS IAM Roles to grant permissions between AWS Services
...
```
# 🎬 043_Udemy - Data Engineering using AWS Data Analytics part1 p43 9. Create and Attach AWS IAM Custom Policy using AWS Web Console
...
```
# 🎬 044_Udemy - Data Engineering using AWS Data Analytics part1 p44 11. Configure and Validate AWS Command Line Interface to run AWS Commands
...
```
# 🎬 045_Udemy - Data Engineering using AWS Data Analytics part1 p45 1. Getting Started with AWS Simple Storage aka S3
...
```
# 🎬 046_Udemy - Data Engineering using AWS Data Analytics part1 p46 3. Setup Data Set locally to upload into AWS s3
...
```
# 🎬 047_Udemy - Data Engineering using AWS Data Analytics part1 p47 5. Adding AWS S3 Buckets and Objects using AWS Web Console
...
```
# 🎬 048_Udemy - Data Engineering using AWS Data Analytics part1 p48 7. Version Control of AWS S3 Objects or Files
...
```
# 🎬 049_Udemy - Data Engineering using AWS Data Analytics part1 p49 9. AWS S3 Cross-Region Replication for fault tolerance
...
```
# 🎬 050_Udemy - Data Engineering using AWS Data Analytics part1 p50 11. Overview of AWS S3 Storage Classes or Storage Tiers
...
```
# 🎬 051_Udemy - Data Engineering using AWS Data Analytics part1 p51 13. Overview of Glacier in AWS s3
...
```
# 🎬 052_Udemy - Data Engineering using AWS Data Analytics part1 p52 15. Managing AWS S3 buckets and objects using AWS CLI
...
```
# 🎬 053_Udemy - Data Engineering using AWS Data Analytics part1 p53 17. Managing Objects in AWS S3 using AWS CLI - Lab
...
```
# 🎬 054_Udemy - Data Engineering using AWS Data Analytics part1 p54 1. Creating AWS IAM Users with Programmatic and Web Console Access
...
```
# 🎬 055_Udemy - Data Engineering using AWS Data Analytics part1 p55 3. Logging into AWS Management Console using AWS IAM User
...
```
# 🎬 056_Udemy - Data Engineering using AWS Data Analytics part1 p56 5. Validate Programmatic Access to AWS IAM User via AWS CLI
...
```
# 🎬 057_Udemy - Data Engineering using AWS Data Analytics part1 p57 7. Getting Started with AWS IAM Identity-based Policies
...
```
# 🎬 058_Udemy - Data Engineering using AWS Data Analytics part1 p58 9. Managing AWS IAM User Groups
...
```
# 🎬 059_Udemy - Data Engineering using AWS Data Analytics part1 p59 11. Managing AWS IAM Roles for Service Level Access
...
```
# 🎬 060_Udemy - Data Engineering using AWS Data Analytics part1 p60 13. Overview of AWS Custom Policies to grant permissions to Users, Groups, and R
...
```
# 🎬 061_Udemy - Data Engineering using AWS Data Analytics part1 p61 15. Managing AWS IAM Groups, Users, and Roles using AWS CLI
...
```
# 🎬 062_Udemy - Data Engineering using AWS Data Analytics part1 p62 1. Getting Started with AWS Elastic Cloud Compute aka EC2
...
```
# 🎬 063_Udemy - Data Engineering using AWS Data Analytics part1 p63 3. Create AWS EC2 Key Pair for SSH Access
...
```
# 🎬 064_Udemy - Data Engineering using AWS Data Analytics part1 p64 5. Launch AWS EC2 Instance or Virtual Machine
...
```
# 🎬 065_Udemy - Data Engineering using AWS Data Analytics part1 p65 7. Connecting to AWS EC2 Instance or Virtual Machine using SSH
...
```
# 🎬 066_Udemy - Data Engineering using AWS Data Analytics part1 p66 9. Overview of AWS Security Groups for firewall security of AWS EC2 Instance
...
```
# 🎬 067_Udemy - Data Engineering using AWS Data Analytics part1 p67 11. Overview of Public and Private IP Addresses of AWS EC2 Instance
...
```
# 🎬 068_Udemy - Data Engineering using AWS Data Analytics part1 p68 13. Understanding AWS EC2 Instance or Virtual Machine Life Cycle
...
```
# 🎬 069_Udemy - Data Engineering using AWS Data Analytics part1 p69 15. Allocating and Assigning AWS Elastic IP or Static IP address to AWS EC2 Inst
...
```
# 🎬 070_Udemy - Data Engineering using AWS Data Analytics part1 p70 17. Managing AWS EC2 Instances or Virtual Machines Using AWS CLI
...
```
# 🎬 071_Udemy - Data Engineering using AWS Data Analytics part1 p71 19. Upgrade or Downgrade of AWS EC2 Instances or Virtual Machines
...
```
# 🎬 072_Udemy - Data Engineering using AWS Data Analytics part1 p72 1. Understanding AWS EC2 Instance or Virtual Machine Metadata
...
```
# 🎬 073_Udemy - Data Engineering using AWS Data Analytics part1 p73 3. Querying on AWS EC2 Instance or Virtual Machine Metadata
...
```
# 🎬 074_Udemy - Data Engineering using AWS Data Analytics part1 p74 5. Fitering on AWS EC2 Instance or Virtual Machine Metadata
...
```
# 🎬 075_Udemy - Data Engineering using AWS Data Analytics part1 p75 7. Using Bootstrapping Scripts on AWS EC2 Instance or Virtual Machine
...
```
# 🎬 076_Udemy - Data Engineering using AWS Data Analytics part1 p76 9. Create an Amazon Machine Image aka AMI using AWS EC2 Instance
...
```
# 🎬 077_Udemy - Data Engineering using AWS Data Analytics part1 p77 11. Validate Amazon Machine Image aka AMI - Lab
...
```
# 🎬 078_Udemy - Data Engineering using AWS Data Analytics part1 p78 1. Hello World using AWS Lambda
...
```
# 🎬 079_Udemy - Data Engineering using AWS Data Analytics part1 p79 3. Setup Project for local development
...
```
# 🎬 080_Udemy - Data Engineering using AWS Data Analytics part1 p80 5. Deploy Project to AWS Lambda console
...
```
# 🎬 081_Udemy - Data Engineering using AWS Data Analytics part1 p81 7. Develop download functionality using requests
...
```
# 🎬 082_Udemy - Data Engineering using AWS Data Analytics part1 p82 9. Using 3rd party libraries in AWS Lambda
...
```
# 🎬 083_Udemy - Data Engineering using AWS Data Analytics part1 p83 11. Validating s3 access for local development
...
```
# 🎬 084_Udemy - Data Engineering using AWS Data Analytics part1 p84 13. Develop upload functionality to s3
...
```
# 🎬 085_Udemy - Data Engineering using AWS Data Analytics part1 p85 15. Validating using AWS Lambda Console
...
```
# 🎬 086_Udemy - Data Engineering using AWS Data Analytics part1 p86 17. Run using AWS Lambda Console
...
```
# 🎬 087_Udemy - Data Engineering using AWS Data Analytics part1 p87 19. Validating files incrementally
...
```
# 🎬 088_Udemy - Data Engineering using AWS Data Analytics part1 p88 21. Reading and Writing Bookmark using s3
...
```
# 🎬 089_Udemy - Data Engineering using AWS Data Analytics part1 p89 23. Maintaining Bookmark using s3
...
```
# 🎬 090_Udemy - Data Engineering using AWS Data Analytics part1 p90 25. Review the incremental upload logic
...
```
# 🎬 091_Udemy - Data Engineering using AWS Data Analytics part1 p91 26. Deploying lambda function
...
```
# 🎬 092_Udemy - Data Engineering using AWS Data Analytics part1 p92 28. Schedule Lambda Function using AWS Event Bridge
...
```
# 🎬 093_Udemy - Data Engineering using AWS Data Analytics part1 p93 1. Setup Virtual Environment and Install Pyspark
...
```
# 🎬 094_Udemy - Data Engineering using AWS Data Analytics part1 p94 3. Getting Started with Pycharm
...
```
# 🎬 095_Udemy - Data Engineering using AWS Data Analytics part1 p95 5. Passing Run Time Arguments
...
```
# 🎬 096_Udemy - Data Engineering using AWS Data Analytics part1 p96 6. Accessing OS Environment Variables
...
```
# 🎬 097_Udemy - Data Engineering using AWS Data Analytics part1 p97 7. Getting Started with Spark
...
```
# 🎬 098_Udemy - Data Engineering using AWS Data Analytics part1 p98 8. Create Function for Spark Session
...
```
# 🎬 099_Udemy - Data Engineering using AWS Data Analytics part1 p99 10. Setup Sample Data
...
```
# 🎬 100_Udemy - Data Engineering using AWS Data Analytics part1 p100 11. Read data from files
